...
class Posts extends React.Component {
    ...
    async componentDidMount() {
        ...
        try {
            ...
            const posts = await strapi.getEntries('blog-posts');
        ...
        <div>
                    ...
                    <div className="posts">
                        <div className="PostCarousel">
                            <div className="PostTitle">Projects</div>
                            <div className="carousel">
                                
                                {this.state.posts.map(post => (
                                    
                                    <div>
                                        <PostCard link={`${env.domain.site}/site/${post.id-1}`} thumbnail={`${env.domain.api}${post.thumbnail.formats.small.url}`} postCardTitle={post.title} subtitle={post.content} tag={post.tag}/>
                                    </div>
                                ))}
                            </div>
                        </div>
